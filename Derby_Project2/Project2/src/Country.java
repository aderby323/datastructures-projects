...
public class Country
{
    ...
    public Country(String name, String code, String capital, String population, String gdp, String hapRank) {
        ...
        gdpPerCapita = Double.parseDouble(gdp) / Double.parseDouble(population);
    }
    /**
     ...
     * @return  boolean True if two countries match and False if countries do not match.
     */
